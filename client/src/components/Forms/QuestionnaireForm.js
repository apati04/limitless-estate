        ...
        <div className="row m-4">
          <div className="col-md-6">
            ...
            <div>
              ...
              <div className="form-group">
                <Field className="form-control" type="text" name="question3" />
              </div>
            </div>
            <div>
            ...
            <div>
              <label htmlFor="question7">7. Are you an accredited investor? (Makes more than $200k annually for the past 2 years and will do so in this current year or have a net worth of $1M excluding your primary residence)</label>
              <div className="form-group">
                <Field className="form-control" type="text" name="question7" />
              </div>
            </div>
          </div>
          <div className="col-md-6">
            <div>
              ...
              <div className="form-group">
                <Field className="form-control" type="text" name="question8" />
              </div>
            </div>
            <div>
              <label htmlFor="question9">9. How would you rate your risk tolerance?</label>
              <div className="form-group">
                <Field type="radio" name="question9" value="Low" />
                <label htmlFor="question9">Low</label>
                <Field type="radio" name="question9" value="Moderate" />
                <label htmlFor="question9">Moderate</label>
                <Field type="radio" name="question9" value="High" />
