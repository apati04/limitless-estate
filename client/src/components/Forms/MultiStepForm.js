            ...
            <div className="col-12 py-1">
              <div className="form-group m-0 pb-0">
                <label className="label" htmlFor="q10">
                  If you are based outside of the US, have you invested in the
                  US real estate market in the past?
                </label>
              ...
              <div className="form-group p-0">
                ...
                <label className="label">
                  <small className="form-text text-muted p-0">
                    ...
                    non-refundable equity to create an alignment of interest to
                    close.)
                  </small>
                </label>
