      ...
      case 'EXECUTIVE_SUMMARY':
        return (
          <Content
            ...
            content_4="We have not yet completed due diligence. If due diligence materials differ in our assumptions, we will either re-negotiate the terms or terminate the contract."
          ...
          <div className="container-fluid">
            <div className="row justify-content-between">
              ...
              <div className="col-12 col-md-6 mt-4">
                <article>{this.renderData()}</article>
