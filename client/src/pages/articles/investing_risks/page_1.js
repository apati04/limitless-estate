        ...
        <Article
          ...
          body={[
            ...
            <p key="3">
              ...
              required to expend significant amounts of money to correct defects
              or make improvements before a property can be sold. Moreover, the
              overall economic conditions that might cause the Fund to want to
              sell properties are generally the same as those in which it would
            ...
            <p key="6">
              ...
              Competition from existing properties and new construction; Changes
              in national or local economic conditions; Changes in zoning;
              Environmental contamination or liabilities; Changes in local
              market conditions; Fires, floods, and other casualties; Uninsured
            ...
            <div key="7">
              <p>
                ...
                Our success depends on our ability to attract and retain tenants
                in our properties. The risks we face include the following:
              </p>
              <ul>
                <li key="7a">
                  Competition from other landlords could keep us from raising
                  rents, or require us to provide financial or other inducements
                  or concessions to attract tenants (g., rent concessions or
                  costs incurred for tenant improvements).
                </li>
                <li key="7b">
                  Changes in economic conditions generally could reduce demand
                  for our properties.
                </li>
                <li key="7c">Existing tenants might not renew their leases.</li>
                <li key="7d">
